...
public class search_customer_form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        searchbtn.setFont(new java.awt.Font("Malayalam MN", 1, 18)); // NOI18N
        ...
        jPanel2.add(searchbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 310, 150, 50));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jFramePackage/images/search_Customer.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(730, 546));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_customer_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new search_customer_form().setVisible(true);
            }
        });
    }
